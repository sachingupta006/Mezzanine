...
#### CUSTOM ######
# This template tag is used for rendering the comment form for the logged in user
# the form will have only the comment field, rest else has already been filled from
# the logged in user details
@register.inclusion_tag("generic/includes/comment_form.html", takes_context=True)
def comment_form_for(context, form):
    """
